...
<div class="bg-gray-200 bg-opacity-25 grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8 p-6 lg:p-8">
    <div>
        <div id="screenshot-container" class="relative flex overflow-hidden w-full flex-1 items-stretch">
    ...
    <div>
        ...
        <p class="mt-4 text-sm">
            <a href="{{ route('spotify.redirect') }}" class="inline-flex items-center font-semibold text-indigo-700">
                Login
